...
# # COMMAND ----------
# os.system('cp /tmp/apple_health_export/export.xml /dbfs/tmp/jesus.rodriguez@databricks.com/asdf/')
# # dbutils.fs.cp('file:/tmp/apple_health_export/export.xml','/tmp/jesus.rodriguez@databricks.com/asdf/')

# os.system('ls /tmp/apple_health_export/export.xml')
...
xmldata =(spark
          .read
          .format('text')
          .load("/tmp/jesus.rodriguez@databricks.com/asdf/export.xml")
         )
# display(xmldata)
